#Liam McDonough, Eric Flynn, Hari Sundaramann
#11/5/2021
...
while True:
    wn.update()
    read = ser.readline()
    controller_read = read.decode()
    controller = controller_read.rstrip()
    ...
    if head.distance(food) < 20:
       ...
       # if head.insert(0, list(head.goto)):
        #    if head.goto[0] == food.goto[0] and head.goto[1] == food.goto[1]:
